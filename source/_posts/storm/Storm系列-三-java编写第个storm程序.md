---
title: Storm系列(三)java编写第个storm程序
...
## storm实现单词计数器统计
![在这里插入图片描述](https://user-gold-cdn.xitu.io/2019/1/5/1681c0d7a465181f?w=298&h=264&f=png&s=14505)
...
```
![在这里插入图片描述](https://user-gold-cdn.xitu.io/2019/1/5/1681c0d7a47ac4a9?w=876&h=258&f=png&s=43581)
